...
# Add vertical space by using st.write("") or st.markdown("<br>")
...
st.write("")  # Adds another empty space

# Create two new columns for the offerings section
col1, col2 = st.columns([3, 2])
...
# Add vertical space
st.write("")  # Adds more vertical space

# New columns for Job Description and Resume upload
col1, col2 = st.columns([3, 2])
...
# Add vertical space
st.write("")  # More vertical space

# Columns for FAQ section
